...
export function AidesPage() {
  ...
  const stats = [
    ...
    { value: 37, label: 'Étudiants éligibles à une bourse CROUS', suffix: '%', color: 'teal' as const },
    { value: 34, label: 'Qui la demandent réellement (3% perdus)', suffix: '%', color: 'orange' as const },
    { value: 48, label: 'Ne savaient pas que des aides existaient', suffix: '%', color: 'red' as const },
    { value: '6 335€', label: 'Montant maximum bourse annuelle (échelon 7)', color: 'green' as const },
    { value: 400, label: 'APL mensuelle maximum en zone tendue', suffix: '€', color: 'green' as const },
  ];
  ...
  const echelonsCROUS = [
    ...
    ['5', '< 17 400€', <span className="text-[#3fb950] font-bold">4 375€</span>, <span className="text-[#3fb950] font-bold">364€</span>, 'Oui'],
    ['6', '< 13 900€', <span className="text-[#3fb950] font-bold">5 007€</span>, <span className="text-[#3fb950] font-bold">417€</span>, 'Oui'],
    ['7', '< 10 300€', <span className="text-[#3fb950] font-bold">6 335€</span>, <span className="text-[#3fb950] font-bold">527€</span>, 'Oui'],
  ];

  const toutesAides = [
    ['Aide', 'Montant max', 'Pour qui', 'Quand demander', 'Lien officiel'],
    ['Bourse CROUS', '6 335€/an', 'Sous conditions revenu', 'Janv → Mai', <a href="https://www.messervices.etudiant.gouv.fr" target="_blank" rel="noopener noreferrer" className="text-[#3ECFCF] hover:underline">messervices.etudiant.gouv.fr ↗</a>],
    ['APL logement', '400€/mois', 'Locataires étudiants', 'Dans le mois', <a href="https://www.caf.fr" target="_blank" rel="noopener noreferrer" className="text-[#3ECFCF] hover:underline">caf.fr ↗</a>],
  ...
  const aides: Aide[] = [
    ...
    },
    {
      ...
      montant: 'Jusqu\'à 400€/mois',
      badge: 'Locataires',
      description: 'Allocation logement pour tous les étudiants locataires, que ce soit en CROUS ou en logement privé.',
  ...
  return (
    <div className="min-h-screen pt-28 pb-16">
      <div className="max-w-6xl mx-auto px-6">
        <Breadcrumb items={[{ label: 'Accueil', href: '/' }, { label: 'Aides Financières' }]} />
        ...
        >
          ...
          <div>
            ...
            <div className="bg-[#3fb950]/10 border border-[#3fb950] rounded-xl p-4 mt-4">
              <p className="text-white text-sm">
                <strong className="text-[#3fb950]">Lien : messervices.etudiant.gouv.fr</strong> - Montants 2023-2024, révisés chaque année. +6% accordés en 2023. Tous les échelons donnent droit à l'exonération des frais d'inscription.
              </p>
            </div>
          </div>
        ...
        >
          <h2 className="text-3xl font-bold text-white mb-6">
            🧮 Calcule ce qu'il te reste ce mois-ci
          </h2>
          <BudgetSimulator />
        </motion.div>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-[#008080]/10 border-2 border-[#008080] rounded-xl p-8 text-center mb-16"
        >
          <h3 className="text-2xl font-bold text-white mb-4">
            Tu ne sais pas par où commencer ?
          </h3>
          <p className="text-[#8b949e] mb-6 max-w-2xl mx-auto">
            Utilise le simulateur ci-dessus pour voir instantanément si tu as droit à des aides.
            Pas de compte requis, pas de données sauvegardées.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold text-white mb-8">Témoignage : une information qui change tout</h2>
          <TestimonialCardLong
            quote="J'ai découvert que j'avais droit à une bourse en novembre de ma 1re année. Ma conseillère d'orientation n'en avait jamais parlé. Ma prof principale non plus. Ma mère gagne 1 100€ par mois - j'aurais eu droit à l'échelon 5 : 364€/mois. Pendant toute mon année, j'ai travaillé 25h par semaine pour compenser. J'ai raté mon semestre. Mon responsable de formation me l'a dit clairement : 'si tu avais eu ta bourse, tu n'aurais pas eu besoin de travailler autant.' Une information. Une seule. C'est tout ce qu'il aurait fallu. Maintenant je le dis à tout le monde dès la rentrée : faites votre DSE en janvier. Pas en mai, pas en septembre. En janvier. Avant que les cours commencent."
            name="Mariam"
            age={21}
            field="Licence Économie"
            city="Paris"
            initials="M"
            color="#0969da"
          />
        ...
        {/* Navigation */}
        <PageNavigation
          previousPage={{ title: 'Études & Réussite', href: '/reussite' }}
          nextPage={{ title: 'Sources', href: '/sources' }}
        />
      </div>
    </div>
  );
