  ...
  return (
    <div className="min-h-screen pt-28 pb-16">
      <div className="max-w-5xl mx-auto px-6">
        <Breadcrumb items={[{ label: 'Accueil', href: '/' }, { label: 'Thématiques', href: '/#themes' }, { label: 'Réussite' }]} />
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold text-white mb-8">Témoignage : le capital social invisible</h2>
          <TestimonialCardLong
            quote="Mon père est ouvrier en usine, ma mère est aide-soignante. Ni l'un ni l'autre n'a fait d'études supérieures. Quand j'ai eu des difficultés en 1re année de BUT, je n'avais personne à appeler pour m'expliquer comment ça marche, une université. Personne pour me dire qu'on peut parler aux profs, qu'on peut demander des aménagements, qu'il existe un tutorat. Mes camarades dont les parents sont ingénieurs ou profs - ils savaient tout ça. Ils étaient à l'aise dans ce monde parce que leurs parents l'avaient fait avant eux. Moi j'avais peur de déranger. J'avais l'impression que l'université n'était pas fait pour moi. On appelle ça le 'capital social'. On ne l'enseigne nulle part. Mais il fait toute la différence entre ceux qui réussissent et ceux qui abandonnent."
            name="Dylan"
            age={22}
        ...
        {/* Navigation */}
        <PageNavigation
          previousPage={{ title: 'Alimentation', href: '/alimentation' }}
          nextPage={{ title: 'Aides Financières', href: '/aides' }}
        />
      </div>
    </div>
  );
