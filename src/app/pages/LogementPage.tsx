...
export function LogementPage() {
  ...
  const loyersParVille = [
    { label: 'Paris', value: 900, color: '#f85149', secondValue: 914, secondColor: '#008080' },
    { label: 'Lyon', value: 580, color: '#E8731A', secondValue: 914, secondColor: '#008080' },
    { label: 'Bordeaux', value: 530, color: '#E8731A', secondValue: 914, secondColor: '#008080' },
    { label: 'Toulouse', value: 490, color: '#d29922', secondValue: 914, secondColor: '#008080' },
    { label: 'Nantes', value: 510, color: '#E8731A', secondValue: 914, secondColor: '#008080' },
    { label: 'Lille', value: 480, color: '#d29922', secondValue: 914, secondColor: '#008080' },
  ];
  ...
  return (
    <div className="min-h-screen pt-28 pb-16">
      <div className="max-w-5xl mx-auto px-6">
        <Breadcrumb items={[{ label: 'Accueil', href: '/' }, { label: 'Thématiques', href: '/#themes' }, { label: 'Logement' }]} />
        ...
        >
          ...
          <p className="text-xl text-[#8b949e] italic text-center max-w-3xl mx-auto">
            Entre dossiers refusés, garants impossibles et visites à la chaîne, la recherche de logement
            peut vite devenir un cauchemar. Voici comment naviguer ce parcours sans perdre espoir.
          </p>
        </motion.div>
        ...
        >
          ...
          <BarChartAnimated
            data={loyersParVille}
            title="Loyers par ville vs budget moyen étudiant (914€)"
            showPercentage={false}
            maxValue={914}
          />
          <div className="bg-[#f85149]/10 border border-[#f85149] rounded-xl p-4 -mt-8">
            <p className="text-white text-sm">
              <strong className="text-[#f85149]">À Paris, le loyer seul représente 98% du budget étudiant moyen.</strong> La barre orange représente le loyer moyen, la barre bleue le budget moyen disponible.
            </p>
          </div>
        ...
        >
          <h2 className="text-3xl font-bold text-white mb-8">Témoignages : la réalité du terrain</h2>
          <TestimonialCardLong
            quote="J'ai envoyé 61 dossiers entre juillet et août pour trouver un appart à Nantes où je venais étudier. Soixante-et-un. J'avais tout préparé : lettre de motivation, relevés de notes, attestation bourse CROUS, justificatif des revenus de mes parents. La plupart ne répondaient pas. Certains ont rappelé, mais dès que je disais 'étudiant, pas de garant CDI, boursier' - la conversation s'arrêtait là. Un propriétaire m'a dit qu'il préférait 'quelqu'un de plus stable'. Son studio était à 380€. J'avais 420€ de bourse. J'aurais très bien pu payer. C'est grâce à Visale que j'ai finalement eu un logement - le propriétaire a changé d'avis en 24h quand il a su que l'État se portait garant à ma place. La solution existait depuis le début. Personne ne me l'avait expliquée lors de mon inscription."
            name="Kévin"
            age={19}
            field="BUT GEA"
            city="Nantes"
          ...
          />
          <TestimonialCardLong
            quote="Je suis arrivée de Martinique pour faire ma licence à Bordeaux. Je n'avais personne sur place. Aucun garant. J'ai vécu 3 semaines dans un Airbnb à 55€/nuit - 1 155€ que je n'avais pas. Ma mère a dû emprunter. Le dossier CROUS, je ne savais pas qu'il fallait le faire en janvier - j'ai appris ça en octobre. J'ai perdu une année entière à cause d'une information que personne ne m'a jamais donnée."
            name="Océane"
            age={19}
            field="Licence Lettres"
            city="Bordeaux"
            initials="O"
            color="#E8731A"
          />
        ...
        {/* Navigation */}
        <PageNavigation
          previousPage={{ title: 'Financement & Budget', href: '/budget' }}
          nextPage={{ title: 'Santé & Bien-être', href: '/sante-mentale' }}
        />
      </div>
    </div>
  );
